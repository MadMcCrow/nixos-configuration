...
let
  ...
  vscode.module = import ./vscode.nix;
  # lapce
...
in {
  ...
  config = lib.mkIf cfg.enable {
    ...
    #(if vscode.enable then vscode.module.vscode.packages else [ ])

    # unfree.unfreePackages = if vscode.enable then vscode.module.vscode.unfree else [ ];
  };
